...
class AIC20_ReID_Simu_Type(BaseImageDataset):
    dataset_dir = 'AIC20_ReID_Simulation'

    def __init__(self, root='datasets', verbose=True, **kwargs):
        super((AIC20_ReID_Simu_Type), self).__init__(root)
        ...
        if verbose:
            print('=> AIC20_ReID_Simu_Type loaded')
    ...
    def process_dir(self):
        type_dict = {0:0, 1:1, 2:2, 3:0, 4:1, 5:3, 6:4, 7:5,8:0, 9:0, 10:6}
        ...
        for i in itemlist:
            if (i.attributes['vehicleID'].value in train_container):
                train_data.append((
                    ...
                    type_dict[int(i.attributes['typeID'].value)], 
