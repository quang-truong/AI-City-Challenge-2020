...
__all__ = ['resnet56_attention', 'resnet92_attention']
...
def resnet56_attention(num_classes, loss={'xent', 'htri'}, **kwargs):
...
def resnet92_attention(num_classes, loss={'xent', 'htri'}, **kwargs):
