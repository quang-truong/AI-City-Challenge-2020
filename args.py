...
def argument_parser():
    ...
    parser.add_argument('--stepsize', default= [2, 4], nargs='+', type=int,
    ...
    parser.add_argument('--combine-eval-dist', default= None, nargs='+', type=str, help='combine multiple distance matrices for evaluation')
    parser.add_argument('--combine-eval-fea', default= None, nargs='+', type=str, help='combine multiple features for evaluation')
    parser.add_argument('--combine-predict', default= None, nargs='+', type=str, help='combine multiple distance matrices for prediction')
    parser.add_argument('--combine-lambda', default= None, nargs='+', type=float, help='weights of distance matrices')
    ...
    parser.add_argument('--extract-features', action='store_true', help='extract features from images')
